...
object Table_I {
   ...
   *   Gamma(EIndirect)
   */
  data class Record(val valueForAlAs: Double, val valueForAlSb: Double, val valueForGaAs: Double, val valueForGaSb: Double)

  /**
   * T independent model parameters
   */
  //@formatter:off
  val values = mapOf(
    ModelParameters.A              to Record(valueForAlAs = 23.740, valueForAlSb = 36.580, valueForGaAs = 5.520, valueForGaSb = 1.102),
